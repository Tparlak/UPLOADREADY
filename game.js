// ============================================
// GAMEDISTRIBUTION SDK CONFIGURATION
// ============================================
window.GD_OPTIONS = {
    gameId: "your_game_id_here", // Replace with actual GD game ID
...
class SlotManager {
    ...
    initSlots() {
        ...
        // Use clientWidth (logical size) for positioning, not width (physical buffer size)
...
class Game {
    constructor() {
        ...
        this.extraSlotsBtn = document.getElementById('extra-slots-btn');
    ...
    init() {
        ...
        // UI buttons
        this.playBtn.addEventListener('click', () => this.startGameWithTransition());
        ...
        this.extraSlotsBtn.addEventListener('click', () => this.useExtraSlots());
    ...
    loadLevel(levelNum) {
        ...
        // Reset/Add Time & Health for new level
        this.timeRemaining = this.maxTime;
        this.health = this.maxHealth;
        this.updateTimerUI();
        this.updateHealthUI();
    ...
    useExtraSlots() {
        // Placeholder for GD Rewarded Ads
        if (typeof gdsdk !== 'undefined' && gdsdk.showRewardedAd) {
            gdsdk.showRewardedAd().then(() => {
                // Grant 2 extra slots
                this.grantExtraSlots();
            });
        } else {
    ...
    checkLevelComplete() {
        ...
        if (nonSlotScrews.length === 0) {
            ...
            if (this.level % 2 === 0 && typeof gdsdk !== 'undefined') {
                gdsdk.showAd();
            }
        }
    }
